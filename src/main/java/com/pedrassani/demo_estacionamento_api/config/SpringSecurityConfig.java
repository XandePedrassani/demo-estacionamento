...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                .csrf(csrf -> csrf.disable())//Como não tem a parte do client isso deve ser desabilitado
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)//Sem contexto
                ).addFilterBefore(
    ...
    public PasswordEncoder passwordEncoder(){
        return new BCryptPasswordEncoder();//Mais seguro atualmente, se a senha sempre for igual mesmo assim ela sempre será diferente encriptografada
    }
    @Bean
